...
The labs in this course are designed to be completed using a DE1-SoC FPGA board. However, under the current public health conditions AND semiconductor chip shortages not everyone has physical access to one.
